...
export default {
  ...
  "presets": [
    [
      ...
      {
        "docs": {
          "sidebarPath": "F:\\PYTHON\\Projects\\sdlc-docusaurus\\sidebars.js",
          "routeBasePath": "docs"
        },
        "blog": false,
        "theme": {
          "customCss": "F:\\PYTHON\\Projects\\sdlc-docusaurus\\src\\css\\custom.css"
        }
      }
    ]
  ],
  "themeConfig": {
    ...
    "footer": {
      ...
      "links": [
        ...
        },
        {
          ...
          "items": [
            ...
            {
              "label": "Configuration",
              "to": "/docs/configuration/webhook-configuration"
            }
          ]
        },
        {
      ...
      "copyright": "Copyright © 2026 SDLC Corp. All rights reserved."
    },
    "prism": {
      "theme": {
        "plain": {
