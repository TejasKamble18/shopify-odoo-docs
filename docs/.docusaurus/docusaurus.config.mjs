...
export default {
  ...
  "presets": [
    [
      ...
      {
        "docs": {
          "sidebarPath": "F:\\PYTHON\\Projects\\SDLC\\docs-shopify-oddo\\docs\\sidebars.js"
        },
        "blog": false,
        "theme": {
          "customCss": "F:\\PYTHON\\Projects\\SDLC\\docs-shopify-oddo\\docs\\src\\css\\custom.css"
        }
      }
    ]
  ],
  "themeConfig": {
    ...
    "footer": {
      "style": "dark",
      "copyright": "Copyright © 2026 SDLC Corp.",
      "links": []
    },
    "colorMode": {
      "defaultMode": "light",
